...
class ModelsTestCase(TestCase):
    def setUp(self):
        ...
        #making test DB SEPARATELY
        Fly.objects.create(origin=a1, destination=a2, duration=100)
        Fly.objects.create(origin=a1, destination=a1, duration=200)
        Fly.objects.create(origin=a1, destination=a2, duration=-100)
    ...
    def test_valid_flight(self):
        ...
        self.assertTrue(f.is_valid_fly())
